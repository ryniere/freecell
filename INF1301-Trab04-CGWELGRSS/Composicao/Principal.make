##################################################
###
### Diretivas de MAKE para o construto: Principal
### Gerado a partir de: Principal.comp
###
...
all : limpa \
   $(Fobj)\principal.obj   $(Fobj)\gerenciador.obj   $(Fobj)\persistencia.obj \
   Construto
...
$(Fobj)\principal.obj :  {$(Pc)}\principal.c \
    {$(Ph)}gerenciador.h       
...
##################################################
###
### Fim de diretivas MAKE para o construto: Principal
###
##################################################
