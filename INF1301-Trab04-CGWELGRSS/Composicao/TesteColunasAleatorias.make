##################################################
###
### Diretivas de MAKE para o construto: TesteColunasAleatorias
### Gerado a partir de: TesteColunasAleatorias.comp
###
...
all : limpa \
   $(Fobj)\testcalt.obj   $(Fobj)\colunas_aleatorias.obj   $(Fobj)\baralho.obj \
   $(Fobj)\lista.obj   $(Fobj)\tratamento_falha.obj   $(Fobj)\carta.obj \
   Construto
...
$(Fobj)\testcalt.obj :  {$(Pc)}\testcalt.c \
    {$(Ph)}baralho.h            {$(Ph)}carta.h              {$(Ph)}colunas_aleatorias.h \
    {$(Ph)}condicao_retorno.h   {$(Ph)}generico.h           {$(Ph)}lerparm.h            \
    {$(Ph)}lista.h              {$(Ph)}privilegiocarta.h    {$(Ph)}tst_espc.h          
...
##################################################
###
### Fim de diretivas MAKE para o construto: TesteColunasAleatorias
###
##################################################
